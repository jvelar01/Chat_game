...
class Game2():
    def __init__(self):
        self.players = [Player2(i) for i in range(2)]
        self.score = [0,0]
        self.lives = [3,3]
        self.running = True
...
class PlayerSprite(pygame.sprite.Sprite):
    def __init__(self,player):
        ...
        self.image = pygame.transform.scale(self.image,(PLAYER_WIDTH2,
                                                        PLAYER_HEIGHT2))
...
class Display2(): 
    def __init__(self, game):
        ...
        self.star = StarSprite( (SIZE2[X]//2, SIZE2[Y]//2) )
        ...
        self.screen = pygame.display.set_mode(SIZE2)
        self.clock =  pygame.time.Clock()  #FPS
        self.background = pygame.image.load('background2.png')
        self.background = pygame.transform.scale(self.background, SIZE2)
        ...
        self.mario_winner = pygame.transform.scale(self.mario_winner,(SIZE2))
        self.bowser_winner = pygame.image.load('bowser_winner.png')
        self.bowser_winner = pygame.transform.scale(self.bowser_winner,(SIZE2))
    ...
    # movimiento, en ese caso no enviamos al servidor del juego el comando que for i in range (10):
